...
Begin MobileTableCustomCell ContentCustomCell
   ...
   Begin MobileMoviePlayer MoviePlayer1
      ...
      AutoLayout      =   MoviePlayer1, 2, <Parent>, 2, False, +1.00, 4, 1, -0, , True
      AutoLayout      =   MoviePlayer1, 3, <Parent>, 3, False, +1.00, 4, 1, 0, , True
      AutoLayout      =   MoviePlayer1, 8, , 0, False, +1.00, 4, 1, 151, , True
      ControlCount    =   0
      Duration        =   0.0
      Enabled         =   True
      HasController   =   True
   ...
   Begin MobileLabel Label1
      ...
      AutoLayout      =   Label1, 7, , 0, False, +1.00, 4, 1, 293, , True
      AutoLayout      =   Label1, 3, MoviePlayer1, 4, False, +1.00, 4, 1, *kStdControlGapV, , True
      AutoLayout      =   Label1, 8, , 0, False, +1.00, 4, 1, 35, , True
      ControlCount    =   0
      Enabled         =   True
      Height          =   35
      Left            =   20

#tag MobileScreen
Begin MobileScreen leaderBoard_screen Implements ARMobileTableSectionHeaderSource,iOSMobileTableDataSource
   BackButtonCaption=   ""
   Compatibility   =   ""
   ControlCount    =   0
   Device = 9
   ...
   Begin iOSMobileTableExtended Table1
      ...
      AutoLayout      =   Table1, 3, <Parent>, 3, False, +1.00, 4, 1, 270, , True
   ...
   Begin Timer Timer1
      ...
      Scope           =   0
   End
   Begin leaders_container leaders_container1
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   leaders_container1, 9, <Parent>, 9, False, +1.00, 4, 1, 0, , True
      AutoLayout      =   leaders_container1, 8, , 0, False, +1.00, 4, 1, 208, , True
      AutoLayout      =   leaders_container1, 3, , 0, False, +1.00, 4, 1, 54, , True
      AutoLayout      =   leaders_container1, 7, , 0, False, +1.00, 4, 1, 376, , True
      ControlCount    =   0
      Enabled         =   True
      Height          =   208
      Left            =   26
